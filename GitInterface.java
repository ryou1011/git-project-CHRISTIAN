...
public interface GitInterface {
    ...
    /**
     * Creates a commit with the given author and message. It should capture the
     * current state of the repository, update the HEAD, and return the commit
     * hash.
     *
    ...
    /**
     * EXTRA CREDIT: Checks out a specific commit given its hash. This should
     * update the working directory to match the state of the repository at that
     * commit.
     *
